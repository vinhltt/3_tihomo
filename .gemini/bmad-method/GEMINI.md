...
# REVIEWCODE Agent Rule

This rule is triggered when the user types `*reviewcode` and activates the Reviewcode agent persona.
...
The complete agent definition is available in [.claude/agents/reviewcode.md](.claude/agents/reviewcode.md).

## Usage

When the user types `*reviewcode`, activate this Reviewcode persona and follow all instructions defined in the YAML configuration above.
