                                                ...
                                                >
                                                    ...
                                                    <div class="p-5">
                                                        ...
                                                        <div class="mt-8 flex items-center justify-end">
                                                            ...
                                                            <button type="button" @click="modal1 = false" class="btn btn-primary ltr:ml-4 rtl:mr-4">
                                                                Save
                                                            </button>
                                                        </div>
                                                    </div>
                                                ...
                                                >
                                                    ...
                                                    <div class="p-5">
                                                        ...
                                                        <div class="mt-8 flex items-center justify-end">
                                                            ...
                                                            <button type="button" @click="modal2 = false" class="btn btn-primary ltr:ml-4 rtl:mr-4">
                                                                Save
                                                            </button>
                                                        </div>
                                                    </div>
                                                ...
                                                >
                                                    ...
                                                    <div class="p-5">
                                                        ...
                                                        <div class="mt-8 flex items-center justify-end">
                                                            ...
                                                            <button type="button" @click="modal3 = false" class="btn btn-primary ltr:ml-4 rtl:mr-4">
                                                                Save
                                                            </button>
                                                        </div>
                                                    </div>
                                        ...
                                        <DialogPanel class="panel w-full max-w-lg overflow-hidden rounded-lg border-0 p-0 text-black dark:text-white-dark">
                                            ...
                                            <div class="p-5">
                                                <p>
                                                    ...
                                                    luctus. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Suspendisse
                                                    potenti. Vivamus ultrices sed urna ac pulvinar. Ut sit amet ullamcorper mi.
                                                </p>
                                        ...
                                        <Dialog as="div" @close="modal5 = false" class="relative z-[51]">
                                            ...
                                            <div class="fixed inset-0 overflow-y-auto">
                                                <div class="flex min-h-full items-start justify-center px-4 py-8">
                                                    ...
                                                    >
                                                        <DialogPanel
                                                            class="panel w-full max-w-5xl overflow-hidden rounded-lg border-0 p-0 text-black dark:text-white-dark"
                                                        >
                                                            <button
                                                                type="button"
                                                                class="absolute top-4 text-gray-400 outline-none hover:text-gray-800 dark:hover:text-gray-600 ltr:right-4 rtl:left-4"
                                                            ...
                                                            <div class="p-5">
                                                                ...
                                                                <div class="mt-8 flex items-center justify-end">
                                                                    <button type="button" @click="modal5 = false" class="btn btn-outline-danger">
                                                                        Discard
                                                                    </button>
                                        ...
                                        <Dialog as="div" @close="modal6 = false" class="relative z-[51]">
                                            ...
                                            <div class="fixed inset-0 overflow-y-auto">
                                                <div class="flex min-h-full items-start justify-center px-4 py-8">
                                                    ...
                                                    >
                                                        <DialogPanel
                                                            class="panel w-full max-w-xl overflow-hidden rounded-lg border-0 p-0 text-black dark:text-white-dark"
                                                        >
                                                            <button
                                                                type="button"
                                                                class="absolute top-4 text-gray-400 outline-none hover:text-gray-800 dark:hover:text-gray-600 ltr:right-4 rtl:left-4"
                                                            ...
                                                            <div class="p-5">
                                                                ...
                                                                <div class="mt-8 flex items-center justify-end">
                                                                    <button type="button" @click="modal6 = false" class="btn btn-outline-danger">
                                                                        Discard
                                                                    </button>
                                        ...
                                        <Dialog as="div" @close="modal7 = false" class="relative z-[51]">
                                            ...
                                            <div class="fixed inset-0 overflow-y-auto">
                                                <div class="flex min-h-full items-start justify-center px-4 py-8">
                                                    ...
                                                    >
                                                        <DialogPanel
                                                            class="panel w-full max-w-sm overflow-hidden rounded-lg border-0 p-0 text-black dark:text-white-dark"
                                                        >
                                                            <button
                                                                type="button"
                                                                class="absolute top-4 text-gray-400 outline-none hover:text-gray-800 dark:hover:text-gray-600 ltr:right-4 rtl:left-4"
                                                            ...
                                                            <div class="p-5">
                                                                ...
                                                                <div class="mt-8 flex items-center justify-end">
                                                                    <button type="button" @click="modal7 = false" class="btn btn-outline-danger">
                                                                        Discard
                                                                    </button>
                                    ...
                                    <div class="fixed inset-0 overflow-y-auto">
                                        <div class="flex min-h-full items-start justify-center px-4 py-8">
                                            <TransitionChild
                                                ...
                                                leave-to="opacity-0 scale-95"
                                            >
                                                <DialogPanel class="relative w-full max-w-3xl overflow-hidden py-8">
                                                    <button
                                                        type="button"
                                                        class="absolute top-4 text-gray-400 outline-none hover:text-gray-800 dark:hover:text-gray-600 ltr:right-4 rtl:left-4"
                                                        @click="modal8 = false"
                                    ...
                                    <TransitionRoot appear :show="modal9" as="template">
                                        <Dialog as="div" @close="modal9 = false" class="relative z-[51]">
                                            ...
                                            <div class="fixed inset-0 overflow-y-auto">
                                                <div class="flex min-h-full items-start justify-center px-4 py-8">
                                                    <DialogPanel
                                                        class="panel animate__animated animate__fadeIn w-full max-w-lg overflow-hidden rounded-lg border-0 p-0 text-black dark:text-white-dark"
                                                    >
                                                        <button
                                                            type="button"
                                                            class="absolute top-4 text-gray-400 outline-none hover:text-gray-800 dark:hover:text-gray-600 ltr:right-4 rtl:left-4"
                                    ...
                                    <TransitionRoot appear :show="modal10" as="template">
                                        <Dialog as="div" @close="modal10 = false" class="relative z-[51]">
                                            ...
                                            <div class="fixed inset-0 overflow-y-auto">
                                                <div class="flex min-h-full items-start justify-center px-4 py-8">
                                                    <DialogPanel
                                                        class="panel animate__animated animate__slideInDown w-full max-w-lg overflow-hidden rounded-lg border-0 p-0 text-black dark:text-white-dark"
                                                    >
                                                        <button
                                                            type="button"
                                                            class="absolute top-4 text-gray-400 outline-none hover:text-gray-800 dark:hover:text-gray-600 ltr:right-4 rtl:left-4"
                                    ...
                                    <TransitionRoot appear :show="modal11" as="template">
                                        <Dialog as="div" @close="modal11 = false" class="relative z-[51]">
                                            ...
                                            <div class="fixed inset-0 overflow-y-auto">
                                                <div class="flex min-h-full items-start justify-center px-4 py-8">
                                                    <DialogPanel
                                                        class="panel animate__animated animate__fadeInUp w-full max-w-lg overflow-hidden rounded-lg border-0 p-0 text-black dark:text-white-dark"
                                                    >
                                                        <button
                                                            type="button"
                                                            class="absolute top-4 text-gray-400 outline-none hover:text-gray-800 dark:hover:text-gray-600 ltr:right-4 rtl:left-4"
                                    ...
                                    <TransitionRoot appear :show="modal12" as="template">
                                        <Dialog as="div" @close="modal12 = false" class="relative z-[51]">
                                            ...
                                            <div class="fixed inset-0 overflow-y-auto">
                                                <div class="flex min-h-full items-start justify-center px-4 py-8">
                                                    <DialogPanel
                                                        class="panel animate__animated animate__slideInUp w-full max-w-lg overflow-hidden rounded-lg border-0 p-0 text-black dark:text-white-dark"
                                                    >
                                                        <button
                                                            type="button"
                                                            class="absolute top-4 text-gray-400 outline-none hover:text-gray-800 dark:hover:text-gray-600 ltr:right-4 rtl:left-4"
                                    ...
                                    <TransitionRoot appear :show="modal13" as="template">
                                        <Dialog as="div" @close="modal13 = false" class="relative z-[51]">
                                            ...
                                            <div class="fixed inset-0 overflow-y-auto">
                                                <div class="flex min-h-full items-start justify-center px-4 py-8">
                                                    <DialogPanel
                                                        class="panel animate__animated w-full max-w-lg overflow-hidden rounded-lg border-0 p-0 text-black dark:text-white-dark"
                                    ...
                                    <TransitionRoot appear :show="modal16" as="template">
                                        <Dialog as="div" @close="modal16 = false" class="relative z-[51]">
                                            ...
                                            <div class="fixed inset-0 overflow-y-auto">
                                                <div class="flex min-h-full items-start justify-center px-4 py-8">
                                                    <DialogPanel
                                                        class="panel animate__animated animate__zoomInUp w-full max-w-lg overflow-hidden rounded-lg border-0 p-0 text-black dark:text-white-dark"
                                                    >
                                                        <button
                                                            type="button"
                                                            class="absolute top-4 text-gray-400 outline-none hover:text-gray-800 dark:hover:text-gray-600 ltr:right-4 rtl:left-4"
                                            ...
                                            <div class="fixed inset-0 overflow-y-auto">
                                                <div class="flex min-h-full items-start justify-center px-4 py-8">
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            <div
                                                                class="flex items-center justify-center p-5 text-base font-medium text-[#1f2937] dark:text-white-dark/70"
                                                            >
                                                                <div
                                                                    class="flex h-16 w-16 items-center justify-center rounded-full bg-[#f1f2f3] dark:bg-white/10"
                                                                >
                                                            ...
                                                            <div class="p-5">
                                                                <div class="text-center text-sm text-white-dark">
                                                                    <p>
                                                                        ...
                                                                        montes, nascetur ridiculus mus. Morbi consequat auctor turpis, vitae dictum augue
                                                                        efficitur vitae. Vestibulum a risus ipsum. Quisque nec lacus dolor. Quisque ornare
                                                                        tempor orci id rutrum.
                                                                    </p>
                                                                </div>
                                                                <div class="mt-8 flex items-center justify-end">
                                                                    <button type="button" class="btn btn-outline-danger" @click="modal17 = false">
                                                                        Discard
                                                                    </button>
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            ...
                                                            <div class="p-5">
                                                                <TabGroup as="div">
                                                                    <TabList class="mt-3 flex flex-wrap border-b border-white-light dark:border-[#191e3a]">
                                                                        <Tab as="template" v-slot="{ selected }">
                                                                            <a
                                                                                href="javascript:;"
                                                                                class="-mb-[1px] block border border-transparent p-3.5 py-2 !outline-none hover:text-primary dark:hover:border-b-black"
                                                                                :class="{
                                                                        ...
                                                                        <Tab as="template" disabled>
                                                                            <a
                                                                                href="javascript:;"
                                                                                class="pointer-events-none -mb-[1px] block p-3.5 py-2 text-white-light dark:text-dark"
                                                                                >Disabled</a
                                                                            >
                                                                        </Tab>
                                                                    </TabList>
                                                                ...
                                                                <div class="mt-8 flex items-center justify-end">
                                                                    <button type="button" @click="modal18 = false" class="btn btn-outline-danger">
                                                                        Discard
                                                                    </button>
                                        ...
                                        <Dialog as="div" @close="modal19 = false" class="relative z-[51]">
                                            ...
                                            <div class="fixed inset-0 overflow-y-auto">
                                                <div class="flex min-h-full items-start justify-center px-4 py-8">
                                                    ...
                                                    >
                                                        <DialogPanel
                                                            class="panel w-full max-w-[300px] overflow-hidden rounded-lg border-0 bg-secondary p-0 text-black dark:bg-secondary dark:text-white-dark"
                                                        >
                                                            <div class="px-5 pt-5 ltr:text-right rtl:text-left">
                                                                <button
                                                                    type="button"
                                                                    class="text-gray-400 outline-none hover:text-gray-800 dark:hover:text-gray-600"
                                                                    @click="modal19 = false"
                                                                >
                                                                    <icon-x />
                                                                </button>
                                                            ...
                                                            <div class="p-5">
                                                                <div class="text-center text-white dark:text-white-light">
                                                ...
                                                <div class="flex min-h-full items-start justify-center px-4 py-8">
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            ...
                                                            <div class="py-5 text-lg font-semibold ltr:pl-5 ltr:pr-[50px] rtl:pl-[50px] rtl:pr-5">Login</div>
                                                            <div class="p-5">
                                                                <form>
                                                                    <div class="relative mb-4">
                                                                        <span
                                                                            class="absolute top-1/2 -translate-y-1/2 dark:text-white-dark ltr:left-3 rtl:right-3"
                                                                        >
                                                            ...
                                                            <div class="border-t border-[#ebe9f1] p-5 text-sm dark:border-white/10">
                                                ...
                                                <div class="flex min-h-full items-start justify-center px-4 py-8">
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            ...
                                                            <div class="py-5 text-lg font-semibold ltr:pl-5 ltr:pr-[50px] rtl:pl-[50px] rtl:pr-5">Register</div>
                                                            <div class="p-5">
                                                                <form>
                                                                    <div class="relative mb-4">
                                                                        <span
                                                ...
                                                <div class="flex min-h-full items-start justify-center px-4 py-8">
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            <button
                                                                type="button"
                                                                class="absolute top-7 text-white-dark outline-none hover:text-dark ltr:right-5 rtl:left-5"
                                                                @click="modal22 = false"
                                                            >
                                                                <icon-x class="h-5 w-5" />
                                                            </button>
                                                            <div class="py-5 text-lg font-semibold ltr:pl-5 ltr:pr-[50px] rtl:pl-[50px] rtl:pr-5">Slider</div>
                                                            <div class="px-5">
                                                                <swiper
