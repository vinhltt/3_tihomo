...
{
    /// <summary>
    /// Adds various services and dependencies to the service collection, including HttpContextAccessor, AutoMapper, UnitOfWork, Validators, Repositories, and Application Services. (EN)<br/>
